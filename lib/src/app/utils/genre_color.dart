...
class GenreColor {
  ...
  static const Map<String, GenreColorScheme> _genreColorMap = {
    'Action': GenreColorScheme(
      backgroundColor: Color(0xFFFF6B6B),
      textColor: Color(0xFFFFFFFF),
    ),
    'Adventure': GenreColorScheme(
      backgroundColor: Color(0xFF4ECDC4),
      textColor: Color(0xFFFFFFFF),
    ),
    'Animation': GenreColorScheme(
      backgroundColor: Color(0xFFFFD93D),
      textColor: Color(0xFF2C3E50),
    ),
    'Comedy': GenreColorScheme(
      backgroundColor: Color(0xFFFFA502),
      textColor: Color(0xFFFFFFFF),
    ),
    'Crime': GenreColorScheme(
    ...
    'Drama': GenreColorScheme(
      backgroundColor: Color(0xFFE74C3C),
      textColor: Color(0xFFFFFFFF),
    ),
    'Family': GenreColorScheme(
      backgroundColor: Color(0xFF1ABC9C),
      textColor: Color(0xFFFFFFFF),
    ),
    'Fantasy': GenreColorScheme(
      backgroundColor: Color(0xFFBB86FC),
      textColor: Color(0xFFFFFFFF),
    ),
    'History': GenreColorScheme(
      backgroundColor: Color(0xFF8B7355),
      textColor: Color(0xFFFFFFFF),
    ),
    'Horror': GenreColorScheme(
      backgroundColor: Color(0xFF1A1A1A),
      textColor: Color(0xFFFFFFFF),
    ),
    'Music': GenreColorScheme(
      backgroundColor: Color(0xFFFF6B9D),
      textColor: Color(0xFFFFFFFF),
    ),
    'Mystery': GenreColorScheme(
      backgroundColor: Color(0xFF663399),
      textColor: Color(0xFFFFFFFF),
    ),
    'Romance': GenreColorScheme(
    ...
    'TV Movie': GenreColorScheme(
      backgroundColor: Color(0xFF5B7CFF),
      textColor: Color(0xFFFFFFFF),
    ),
    'Thriller': GenreColorScheme(
      backgroundColor: Color(0xFFD84315),
      textColor: Color(0xFFFFFFFF),
    ),
    'War': GenreColorScheme(
      backgroundColor: Color(0xFF546E7A),
      textColor: Color(0xFFFFFFFF),
    ),
    'Western': GenreColorScheme(
      backgroundColor: Color(0xFFC17817),
      textColor: Color(0xFFFFFFFF),
    ),
  };
  ...
  static Map<String, GenreColorScheme> getAllColorSchemes() =>
      Map.unmodifiable(_genreColorMap);
