...
import 'package:tmdbmaze/src/feature/connectivity/data/datasources/connectivity_datasource.dart';
import 'package:tmdbmaze/src/feature/connectivity/data/repositories/connectivity_repository_impl.dart';
import 'package:tmdbmaze/src/feature/connectivity/domain/repositories/connectivity_repository.dart';
import 'package:tmdbmaze/src/feature/connectivity/presentation/bloc/connectivity_bloc.dart';
...
Future<void> _setupCoreDependencies() async {
  ...
  // Connectivity
  getIt.registerSingleton<ConnectivityDataSource>(ConnectivityDataSourceImpl());
  getIt.registerSingleton<ConnectivityRepository>(
    ConnectivityRepositoryImpl(dataSource: getIt<ConnectivityDataSource>()),
  );
}
...
void _setupPresentationLayer() {
  ...
  getIt.registerSingleton<ConnectivityBloc>(
    ConnectivityBloc(connectivityRepository: getIt<ConnectivityRepository>()),
  );
}
